  ...
  const closeForm = ()=> {
	...
	return(
      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={12}>
          <InputLabel htmlFor="filled-name-native-simple">Please Select Product</InputLabel>
	        <Select
	          native
	          fullWidth
	          value={state.name}
        ...
        <Grid container  justify="flex-end" className={classes.actionContainer}>
	        <Button onClick={closeForm} variant="outlined" className={classes.marginRight10}>
	          No
	        </Button>
